<?= $this->extend('admin/layouts/layout_authenticated'); ?>


)->render('admin/layouts/partial/header.php') ?>


<?= $this->section('content') ?>
<?= $this->setData([
		'page_title' => 'Dashboard',
		'page_description' => 'Welcome to Mazer Dashboard',
		'breadcrumb' => [
			// ['name' => 'Dashboard', 'to' => 'Admin\DashboardController::index'],
			['name' => 'Index'],
		],
	])->render('admin/layouts/partial/header.php') ?>
